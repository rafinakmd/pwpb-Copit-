    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
              <img src="{{ asset('style/images/a.png') }}" style="width:300px; margin-left:400px; margin-top:100px;">
              <img src="{{ asset('style/images/c.png') }}" style="width:300px; margin-left:400px; margin-top:100px;">
              <br><br><br>
</body>
</html>
